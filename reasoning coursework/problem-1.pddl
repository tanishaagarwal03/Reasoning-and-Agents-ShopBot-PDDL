(define (problem supermarket)
  ...
  (:init
    ...
    (adjacent c8 c7) (adjacent c8 c13) 
    ...
    (adjacent c16 c15) (adjacent c16 c17) (adjacent c16 s5)
    ...
    (adjacent c19 c20) (adjacent c19 c17)
